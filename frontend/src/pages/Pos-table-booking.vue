<template>
	...
	<div class="pos pos-booking" id="pos-booking">
					...
					<div class="d-md-flex align-items-center mb-4">
						...
						<div>
							<div class="input-group date mb-0">
								<input type="date" class="form-control" placeholder="Today's" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
							<a href="javascript:;" v-b-modal.modalPosBooking class="table-booking">
								<div class="table-booking-container">
									...
									<div class="table-booking-body">
										...
										<div class="booking">
											...
											<div class="info">Reserved by Irene (4pax)</div>
		...
		<b-modal modal-class="modal-pos-booking" ref="modalPosBooking" :hide-header="true" size="lg" id="modalPosBooking">
			<div class="d-flex align-items-center mb-3">
				...
				<a @click="hideModal" class="ms-auto btn-close"></a>
			</div>
			<div class="row">
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					...
					<div class="form-group mb-2">
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="" value="Reserved by Irene (4pax)" />
						</div>
					</div>
					<div class="form-group mb-2">
						<div class="input-group">
