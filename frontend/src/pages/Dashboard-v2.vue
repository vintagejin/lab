<template>
	<div>
		...
		<div class="row">
			...
			<!-- BEGIN col-4 -->
			<div class="col-xl-4">
				<panel title="Visitors Origin" noButton="true" bodyClass="p-0">
					<GmapMap class="bg-gray-900" style="height: 170px;" v-bind:options="map" :zoom="3" :center="{lat: 25.304304, lng: -90.06591800000001}"></GmapMap>
		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-6">
				<!-- BEGIN panel -->
				<panel bodyClass="bg-light" noButton="true">
					<template slot="header">
						<h4 class="panel-title">Chat History</h4>
						<span class="badge bg-teal">4 message</span>
					</template>
					<vue-custom-scrollbar class="chats" style="height: 225px">
			...
			<div class="col-xl-4 col-lg-6">
				<!-- BEGIN panel -->
				<panel title="Today's Schedule" noButton="true" bodyClass="p-0" class="rounded overflow-hidden">
					...
					<div class="list-group list-group-flush">
						...
						<a href="javascript:;" v-for="event in events.displayData" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center text-ellipsis">
							{{ event.title }}
							<span class="badge fs-10px" v-bind:class="event.badge">{{ event.time }}</span>
						</a>
					</div>
				</panel>
				<!-- END panel -->
			...
			<div class="col-xl-4 col-lg-6">
				<!-- BEGIN panel -->
				<panel footerClass="text-center" noButton="true" bodyClass="p-0">
					<template slot="header">
