				...
				<panel title="Buttons">
					<div>
						<div class="d-flex flex-wrap">
							...
							<button type="button" class="btn btn-inverse me-1 mb-1">Inverse</button>
...
&lt;a href="#" class="btn btn-primary d-block"&gt;Block Button&lt;/a&gt;</code></pre>
					</div>
					<!-- END hljs-wrapper -->
				</panel>
				<!-- END panel -->
...
&lt;/a&gt;</code></pre>
			...
			<div class="col-xl-6">
				<!-- BEGIN panel -->
				<panel title="Button Groups & Toolbars">
					<div>
						<div class="row">
							<div class="col-md-6">
								<div class="btn-group">
...
&lt;/div&gt;</code></pre>
			...
			<div class="col-xl-6">
				<!-- BEGIN panel -->
				<panel title="Button Group Vertical & Justified">
					<div>
						<div class="row">
							<div class="col-md-4">
					...
					<!-- BEGIN hljs-wrapper -->
					<div class="hljs-wrapper" v-highlight slot="outsideBody">
						<pre><code class="html">&lt;!-- button group vertical --&gt;
...
&lt;/div&gt;</code></pre>
			...
			<div class="col-xl-6">
				...
				<panel title="Button Icon & Sizes">
					...
					<!-- BEGIN hljs-wrapper -->
					<div class="hljs-wrapper" v-highlight slot="outsideBody">
						<pre><code class="html">&lt;a href="#" class="btn btn-default btn-icon btn-lg"&gt;
  &lt;i class="fa fa-expand"&gt;&lt;/i&gt;
&lt;/a&gt;
&lt;a href="#" class="btn btn-default btn-icon"&gt;...&lt;/a&gt;
&lt;a href="#" class="btn btn-default btn-icon btn-sm"&gt;...&lt;/a&gt;
&lt;a href="#" class="btn btn-default btn-icon btn-xs"&gt;...&lt;/a&gt;</code></pre>
					</div>
					<!-- END hljs-wrapper -->
				</panel>
				<!-- END panel -->
