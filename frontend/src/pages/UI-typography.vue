...
&lt;h6&gt;h6. Heading 6&lt;/h6&gt;</code></pre>
				...
				<!-- END panel -->
				<!-- BEGIN panel -->
				<panel title="small, semiBold, Bold, Italic">
...
&lt;/ol&gt;</code></pre>
				...
				<!-- END panel -->
				<!-- BEGIN panel -->
				<panel title="Unstyled & Inline List Classes">
					<div class="text-inverse">
...
&lt;/dl&gt;</code></pre>
				...
				<!-- END panel -->
				<!-- BEGIN panel -->
				<panel title="Horizontal Description List">
					<dl class="row">
