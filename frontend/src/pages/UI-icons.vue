...
&lt;/div&gt;</code></pre>
				...
				<!-- END panel -->
				<!-- BEGIN panel -->
				<panel title="Power Transforms: Rotating & Flipping">
					<div class="fs-14px">
						<div class="fa-3x">
...
&lt;/ul&gt;</code></pre>
				...
				<!-- END panel -->
				<!-- BEGIN panel -->
				<panel title="Bordered & Pulled Icons">
					<div class="fs-14px">
